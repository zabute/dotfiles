...
-- Remove the cursor highlight (background behind cursor)
vim.cmd 'hi Cursor guibg=none guifg=none ctermbg=none ctermfg=none'
-- Remove the cursor line highlight (highlight behind the cursor line)
